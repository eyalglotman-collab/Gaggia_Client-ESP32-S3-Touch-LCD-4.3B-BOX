...
$bodyItems = @(
    ...
    "  upper-level error routing = failed startup stages are routed to visible error handling rather than silently ignored"
    ...
    "  - the client currently builds payloads up to `COMMUNICATION_FRAME_MAX_PAYLOAD`"
